...
module.exports = {
    ...
    plugins: ['ghost', 'prettier'],
    extends: ['plugin:ghost/node', 'prettier'],
    rules: {
        ...
        },
        {
            ...
            rules: {
                'no-restricted-syntax': [
                    ...
                    {
                        selector:
                            "CallExpression[callee.property.name=/join|innerJoin|leftJoin/] CallExpression[callee.property.name=/join|innerJoin|leftJoin/] CallExpression[callee.name='knex']",
